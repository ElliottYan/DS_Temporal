...
import transformer.opts as opts
...
class ArgumentParser(cfargparse.ArgumentParser):
    ...
    def validate_model_opts(cls, model_opt):
        ...
        # this check is here because audio allows the encoder and decoders to
        ...
        assert model_opt.model_type == 'audio' or same_size, \
            "The encoder and decoders rnns must be the same size for now"

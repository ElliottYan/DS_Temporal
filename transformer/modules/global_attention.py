...
from transformer.modules.sparse_activations import sparsemax
from transformer.utils.misc import aeq, sequence_mask

# This class is mainly used by decoders.py for RNNs but also
# by the CNN / transformer decoders when copy attention is used
